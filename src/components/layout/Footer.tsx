  ...
  return (
    <footer className="pt-20 pb-8 mt-16 border-t border-white/8 relative">
      <div className="w-full max-w-[1200px] mx-auto px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-[1.4fr_1fr_1fr_1fr_1fr] gap-8 lg:gap-10 mb-16">
          <div className="col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-2.5 mt-5">
              <a href={URLS.linkedin} target="_blank" rel="noopener" aria-label="LinkedIn" className="w-11 h-11 grid place-items-center rounded-[10px] bg-white/4 border border-white/8 text-brand-text-muted hover:text-brand-text hover:bg-white/8 hover:-translate-y-0.5 transition-all">
              ...
              <a href={URLS.instagram} target="_blank" rel="noopener" aria-label="Instagram" className="w-11 h-11 grid place-items-center rounded-[10px] bg-white/4 border border-white/8 text-brand-text-muted hover:text-brand-text hover:bg-white/8 hover:-translate-y-0.5 transition-all">
